...
//only ouputs the 5th card
//could theoretically copy and paste all this 13 times for all songs
...
//two different loop approaches (actually 4 but just 2 today):
...
//forEach Method does the exact same thing as for of, but with a different functionality
tracks.forEach(track => {
  template = `
  <div data-song ="${track.preview_url}$"
...
const playSong = ev => {
  //currentTarget is what was clicked on
